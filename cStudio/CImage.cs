...
namespace cStudio {
    ...
    class CImage {
        ...
        public string Signature{ get{ return Camera + CamVendor; } }       
        ...
        public bool Load(string fn) {
            ...
            int id, type, vi; string str; //double fi; 
            Rational R;
                foreach (PropertyItem pi in Bmp.PropertyItems) {
                    ...
                    switch (type) {
                        case 2:
                            ...
                            switch (id) {
                                case 272: Camera = str.Trim();
                                    break;
                                case 271: CamVendor = str.Trim();
                                    break;
                                case 36867:
...
#region XML        
        ...
        public virtual void Create(XmlNode xn) {
            Name = xn.Attributes["Name"].Value;            
            FileName = xn.Attributes["FileName"].Value;                                          
        }

        public virtual void AddTo(XmlNode xn) {
            XmlDocument xdoc = xn.OwnerDocument;
            XmlNode xi = xdoc.CreateElement("Image");
            XmlAttribute xa = xdoc.CreateAttribute("Name"); xa.Value = Name;
            xi.Attributes.Append(xa);
            xa = xdoc.CreateAttribute("FileName"); xa.Value = FileName;
            xi.Attributes.Append(xa);
            xn.AppendChild(xi);
        }
#endregion
